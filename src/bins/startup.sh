...
#echo "nohup $JAVA_HOME/bin/java ${JAVA_OPTS} ${CLASS_PATH} -jar $APP_HOME/lib/$APP_NAME.jar  $SERVER_OTPS >$APP_HOME/logs/$APP_NAME.log 2>&1 &"
#eval "nohup $JAVA_HOME/bin/java ${JAVA_OPTS} ${CLASS_PATH} -jar $APP_HOME/lib/$APP_NAME.jar  $SERVER_OTPS >$APP_HOME/logs/$APP_NAME.log 2>&1 &"
